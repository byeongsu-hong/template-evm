...
interface IMitosisVaultMatrix {
  ...
  event MatrixExtraRewardsSettled(
    address indexed hubMatrixVault, address indexed reward, uint256 amount
  );
  ...
  error IMitosisVaultMatrix__StrategyExecutorNotDrained(
    address hubMatrixVault, address strategyExecutor
  );
  ...
  function quoteDepositWithSupplyMatrix(
    address asset,
    address to,
  ...
  function quoteDeallocateMatrix(address hubMatrixVault, uint256 amount)
    external
    view
    returns (uint256);
  function quoteSettleMatrixYield(address hubMatrixVault, uint256 amount)
    external
    view
    returns (uint256);
  function quoteSettleMatrixLoss(address hubMatrixVault, uint256 amount)
    external
    view
    returns (uint256);
